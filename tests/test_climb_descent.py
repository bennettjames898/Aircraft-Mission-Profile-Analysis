...
def test_descent_gamma_residual():
...
if __name__ == "__main__":
    tests = [
        test_climb_gamma_residual,
        test_descent_gamma_residual,
    ...
    print("\nAll Climb/Descent validation checks passed.")